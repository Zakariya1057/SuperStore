...
struct StoreHandler {
    ...
    func processResults(_ data:Data){
        ...
        do {
            ...
            let location:LocationModel = LocationModel(city: storeLocation.city, address_line1: storeLocation.address_line1, address_line2: storeLocation.address_line2, address_line3: storeLocation.address_line3, postcode: storeLocation.postcode)
