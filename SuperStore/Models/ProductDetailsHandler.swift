...
struct ProductDetailsHandler {
    ...
    func processResults(_ data:Data){
        ...
        do {
            ...
            let product = ProductDetailsModel(id: product_details.id, name: product_details.name, image: product_details.large_image, description: product_details.description, quantity: 0, price: product_details.price, avg_rating: product_details.avg_rating, total_reviews_count: product_details.total_reviews_count, promotion: promotion, storage: product_details.storage, weight: product_details.weight, parent_category_id: product_details.parent_category_id, parent_category_name: product_details.parent_category_name, dietary_info: product_details.dietary_info, allergen_info: product_details.allergen_info, brand: product_details.brand, reviews: reviews, favourite: product_details.favourite, ingredients: ingredients, recommended: recommended)
