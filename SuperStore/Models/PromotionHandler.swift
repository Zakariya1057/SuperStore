    ...
    func processResults(_ data:Data){
        ...
        do {
            ...
            for product_item in promotion_data.products ?? [] {
                products.append(ProductModel(id: product_item.id, name: product_item.name, image: product_item.small_image, description: product_item.description, price: (product_item.price as NSString).doubleValue, location: "", avg_rating: product_item.avg_rating, total_reviews_count: product_item.total_reviews_count))
            }
