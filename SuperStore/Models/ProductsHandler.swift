    ...
    func processResults(_ data:Data){
        ...
        do {
            ...
            for hour in storeHours {
                opening_hours.append(OpeningHoursModel(opens_at: hour.opens_at, closes_at: hour.closes_at, closed_today: hour.closed_today ?? false, day_of_week: hour.day_of_week))
            }
